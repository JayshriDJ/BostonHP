...
app.config["MYSQL_PASSWORD"] = "Welcome2022"
app.config["MYSQL_DB"]  = "BostanHouse"
mysql = MySQL(app)
...
def predict1():
    ...
    query = "CREATE TABLE IF NOT EXISTS boston_house_price(CRIM VARCHAR(20),ZN VARCHAR(20),INDUS VARCHAR(20),CHAS VARCHAR(20),NOX VARCHAR(20),RM VARCHAR(20),AGE VARCHAR(20),DIS VARCHAR(20),RAD VARCHAR(20),TAX VARCHAR(20),PTRATIO VARCHAR(20),B VARCHAR(20),LSTAT VARCHAR(20),PRICE VARCHAR(20))"
    cursor.execute(query)
    cursor.execute("INSERT INTO boston_house_price(CRIM,ZN,INDUS,CHAS,NOX,RM,AGE,DIS,RAD,TAX,PTRATIO,B,LSTAT,PRICE) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(a,b,c,d,e,f,g,h,i,j,k,l,m,z1))
